...
class Mega(BaseModel):
    def __init__(self, dataset: List[BaseEHRDataset], feature_keys: List[str], label_key: str, mode: str,
        ...
        if os.path.isfile('../saved_files/conditional_prob_matrix.csv'):
            # Load the DataFrame if the file exists
            self.conditional_prob_matrix_l3 = pd.read_csv('../saved_files/conditional_prob_matrix.csv')
        ...
        if os.path.isfile('../saved_files/conditional_prob_matrix1.csv') and os.path.isfile(
                '../saved_files/conditional_prob_matrix2.csv'):
            # Load the DataFrame if the file exists
            self.conditional_prob_matrix_l1 = pd.read_csv('../saved_files/conditional_prob_matrix1.csv')
            ...
            self.conditional_prob_matrix_l2 = pd.read_csv('../saved_files/conditional_prob_matrix2.csv')
        ...
        if os.path.isfile(self.gpt_embd_path+'dx1_gpt_emb.npy'):

            self.dx1_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'dx1_gpt_emb.npy'), dtype=torch.float32)
            self.dx2_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'dx2_gpt_emb.npy'), dtype=torch.float32)
            self.dx3_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'dx3_gpt_emb.npy'), dtype=torch.float32)

            self.rx1_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'rx1_gpt_emb.npy'), dtype=torch.float32)
            self.rx2_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'rx2_gpt_emb.npy'), dtype=torch.float32)
            self.rx3_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'rx3_gpt_emb.npy'), dtype=torch.float32)

            self.px1_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'px1_gpt_emb.npy'), dtype=torch.float32)
            self.px2_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'px2_gpt_emb.npy'), dtype=torch.float32)
            self.px3_gpt_emb = torch.tensor(np.load(self.gpt_embd_path + 'px3_gpt_emb.npy'), dtype=torch.float32)
    ...
    def creat_llm_emb(self):
        ...
        np.save(self.gpt_embd_path + 'dx1_gpt_emb.npy', dx1_gpt_emb)
        ...
        np.save(self.gpt_embd_path + 'dx2_gpt_emb.npy', dx2_gpt_emb)
        ...
        np.save(self.gpt_embd_path + 'dx3_gpt_emb.npy', dx3_gpt_emb)
        ...
        np.save(self.gpt_embd_path + 'rx1_gpt_emb.npy', rx1_gpt_emb)
        ...
        np.save(self.gpt_embd_path + 'rx2_gpt_emb.npy', rx2_gpt_emb)
        ...
        np.save(self.gpt_embd_path + 'rx3_gpt_emb.npy', rx3_gpt_emb)
        ...
        np.save(self.gpt_embd_path+ 'px1_gpt_emb.npy', px1_gpt_emb)
        ...
        np.save(self.gpt_embd_path+ 'px2_gpt_emb.npy', px2_gpt_emb)
        ...
        np.save(self.gpt_embd_path+ 'px3_gpt_emb.npy', px3_gpt_emb)
    ...
    def get_co_occurrence(self):
        ...
        conditional_prob_matrix_reordered.to_csv('../saved_files/conditional_prob_matrix.csv')
    ...
    def get_co_occurrence_for_parents(self):
        ...
        conditional_prob_matrix1.to_csv('../saved_files/conditional_prob_matrix1.csv')
        conditional_prob_matrix2.to_csv('../saved_files/conditional_prob_matrix2.csv')


        self.conditional_prob_matrix1 = conditional_prob_matrix1
        self.conditional_prob_matrix2 = conditional_prob_matrix2
