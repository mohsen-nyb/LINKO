...
def nfold_experiment(mimic3sample, epochs , ds_size_ratio, print_results=True, record_results=True):
    ...
    if os.path.isfile('../saved_files/label_fr/groups_dict_mimic3.pkl'):
        pass
        # Load the Counter dictionary from a file
        # with open('../saved_files/label_fr/groups_dict_mimic3_1.pkl', 'rb') as file:
        #     groups1 = pickle.load(file)
        # with open('../saved_files/label_fr/groups_dict_mimic3_2.pkl', 'rb') as file:
        #     groups2 = pickle.load(file)
        # with open('../saved_files/label_fr/co_occurrence_counts_mimic3.pkl', 'rb') as file:
        #     co_occurrence_counts = pickle.load(file)
    else:
        data = mimic3sample.samples
        co_occurrence_counts, groups1 = get_group_labels1(data)
        # co_occurrence_counts, groups2 = get_group_labels2(data)

        # Save the Counter dictionary to a file
        # with open('../saved_files/label_fr/co_occurrence_counts_mimic3.pkl', 'wb') as file:
        #     pickle.dump(co_occurrence_counts, file)
        #
        # # Save the Counter dictionary to a file
        # with open('../saved_files/label_fr/groups_dict_mimic3_1.pkl', 'wb') as file:
        #     pickle.dump(groups1, file)

        # # Save the Counter dictionary to a file
        # with open('../saved_files/label_fr/groups_dict_mimic3_2.pkl', 'wb') as file:
        #     pickle.dump(groups2, file)
    ...
    for seed in seeds:
        ...
        trainer = Trainer(model=model,
                          ...
                          enable_logging=True,
                          output_path="./output/previous_best_gram_gat_hap_hypergraph_bugged_selfloop_attention_node_optimized_final2_new_prompt_including_parents2",
    ...
    if record_results:
        with open(f'results_prompting/metrics_results_BestModel_Hypergraph_bugged_selfloop_attention_node_optimized_final2_new_prompt_including_parents2.txt', 'w') as file:
            file.write('\n')
